        ...
        <Grid centered columns="equal">
          ...
          <Grid.Column>
            <div className="about-container">
              <Segment className="no-margin  about-header" inverted>
                <h1>Hey, I'm Jesse</h1>
              </Segment>
          ...
          // style={width < breakpoint ? mobileBorder : desktopBorder}
            ...
            <div className="about-container">
              <Segment size="large" inverted className="no-margin">
                ...
                <p>
                  Check out the photos below for a glimpse into some of my adventures and creations.
                </p>
              </Segment>
            <Segment textAlign="center" className="no-margin" inverted>
            <Image
          ...
          <Grid.Column>
            <div style={width > breakpoint ? {marginTop: '3rem'} : null} className="about-container">
            <Segment textAlign="center" className="no-margin" inverted>
              <Image
                size="large"
                centered
